...
export const seed = mutation({
  handler: async (ctx) => {
    // 1. Create Shops
    const shops = [
      { code: "JA", name: "JA Shop", location: "Nyeri" },
      { code: "JC", name: "JC Shop", location: "Nyeri" },
      { code: "E1", name: "E1 Shop", location: "Nakuru" },
      { code: "E2", name: "E2 Shop", location: "Nakuru" },
      { code: "E3", name: "E3 Shop", location: "Nakuru" },
      { code: "E4", name: "E4 Shop", location: "Nakuru" },
    ];
